<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="assets/img/sample_0.jpg" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
            <img src="assets/img/sample_2.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="assets/img/sample_1.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption">
                <h5>Automação</h5>
                ...
                <div class="col-md-12 p-0 pt-4 pb-4">
                    <form action="#" class="p-4 m-auto form-contato">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <input id="email" name="email" class="form-control" placeholder="E-mail" required="" type="email">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <button href="inscricao.php" class="enviar-button">Enviar Agora</button>
                        </div>
                    </form>
                </div>
            </div>
