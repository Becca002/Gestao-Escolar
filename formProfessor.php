...
if (isset($_GET['acao']) && $_GET['acao'] != 'insert' && $cod_professor !== null) {
    $dados = $db->dbSelect(
    ...
    <form class="g-3" action="<?= $_GET['acao'] ?>professor.php" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-4 mt-3">
                ...
                <input type="text" class="form-control" id="salario" name="salario" required dir="rtl" value="<?= Funcoes::setValue($dados, 'salario') ?>">
            </div>
